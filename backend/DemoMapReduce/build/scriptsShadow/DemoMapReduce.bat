...
set CLASSPATH=%APP_HOME%\lib\DemoMapReduce-0.0.1-SNAPSHOT-all.jar

@rem Execute DemoMapReduce
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_MAP_REDUCE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%DEMO_MAP_REDUCE_EXIT_CONSOLE%" exit 1
exit /b 1
